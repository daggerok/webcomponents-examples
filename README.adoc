= webcomponents-playground image:https://travis-ci.org/daggerok/webcomponents-playground.svg?branch=07-extending-custom-element-using-template["Build Status", link="https://travis-ci.org/daggerok/webcomponents-playground"]
